    ...
    if (req.body.userId !== req.params.id) {
        try {
            ...
            if (!user.followers.includes(req.body.userId)) {
                ...
                return res.status(403).json("Already followed this user");
            }
        } catch (err) {
            return res.status(500).json(err);
        }
    ...
    if (req.body.userId !== req.params.id) {
        try {
            ...
            if (user.followers.includes(req.body.userId)) {
                ...
                res.status(200).json("You have unfollowed user succesfully");
            } else {
        ...
        return res.status(403).json("You cannot unfollow or follow yourself");
    }
})
